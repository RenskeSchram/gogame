...
public class GoBoardGui {
  ...
  public void placeStone(int[] intersection, Color color) {
    gogui.addStone(intersection[0], intersection[1], color == Color.WHITE);
  }

  public void removeStone(int[] intersection) {
    gogui.removeStone(intersection[0], intersection[1]);
  }
